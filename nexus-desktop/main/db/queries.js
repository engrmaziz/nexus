...
function getStatements() {
  ...
  return {
    ...
    updateDownloadProgress:  db.prepare(`UPDATE downloads SET downloaded=@downloaded, speed=@speed, progress=@progress, eta_seconds=@eta, size=@size, updated_at=datetime('now') WHERE id=@id`),
